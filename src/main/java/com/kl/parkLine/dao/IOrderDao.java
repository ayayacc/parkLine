...
public interface IOrderDao extends JpaRepository<Order, Integer>, QuerydslPredicateExecutor<OrderVo>
{
    ...
    public List<Order> findByTypeAndCarAndParkAndEndDateGreaterThanEqualAndStatusInOrderByStartDate(OrderType orderType, Car car, Park park, Date inDate, List<OrderStatus> status);
